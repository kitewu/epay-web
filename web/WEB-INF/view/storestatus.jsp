...
<section>
    ...
    <div class="main-content">
        ...
        <div id="page-wrapper">
            <div class="graphs">
                <h3 class="blank1">商店状态</h3>
                <div class="col_3">
                    <div class="col-md-3 widget widget1">
                        <div class="r3_counter_box">
                            <i class="fa fa-mail-forward"></i>
                            <div class="stats">
                                <h5>178 <span>件</span></h5>
                                <div class="grow">
                                    <p>销售量</p>
                                </div>
                            </div>
                            ...
                            <div class="scrollbar scrollbar1" id="style-2">
                                <div class="activity-row">
                                    <div class="col-xs-3 activity-img">
                                        <img src="../../source/images/1.png" class="img-responsive" alt=""/>
                                    </div>
                                ...
                                <div class="activity-row">
                                    <div class="col-xs-3 activity-img">
                                        <img src="../../source/images/5.png" class="img-responsive" alt=""/>
                                    </div>
                                    <div class="col-xs-7 activity-desc">
                                ...
                                <div class="activity-row">
                                    <div class="col-xs-3 activity-img">
                                        <img src="../../source/images/3.png" class="img-responsive" alt=""/>
                                    </div>
                                    <div class="col-xs-7 activity-desc">
                                ...
                                <div class="activity-row">
                                    <div class="col-xs-3 activity-img">
                                        <img src="../../source/images/4.png" class="img-responsive" alt=""/>
                                    </div>
                                    <div class="col-xs-7 activity-desc">
                                    ...
                                    <div class="single-bottom">
                                        <ul>
                                            <li><input type="checkbox" id="brand" value=""/> <label
                                                    for="brand"><span></span> Sunt in culpa qui officia.</label></li>
                                            <li><input type="checkbox" id="brand1" value=""/> <label
                                                    for="brand1"><span></span> Fugiat quo voluptas nulla.</label></li>
                                            <li><input type="checkbox" id="brand2" value=""/> <label
                                                    for="brand2"><span></span> Dolorem eum.</label></li>
                                            <li><input type="checkbox" id="brand9" value=""/> <label
                                                    for="brand9"><span></span> Pain that produces no resultant.</label>
                                            </li>
                                            <li><input type="checkbox" id="brand8" value=""/> <label
                                                    for="brand8"><span></span> Cupidatat non proident.</label></li>
                                            <li><input type="checkbox" id="brand7" value=""/> <label
                                                    for="brand7"><span></span> Praising pain was born.</label></li>
                                            <li><input type="checkbox" id="brand3" value=""/> <label
                                                    for="brand3"><span></span> Computer &amp; Electronics</label></li>
                                            <li><input type="checkbox" id="brand4" value=""/> <label
                                                    for="brand4"><span></span> Dolorem ipsum quia.</label></li>
                                            <li><input type="checkbox" id="brand5" value=""/> <label
                                                    for="brand5"><span></span> Consequatur aut perferendis.</label></li>
                                            <li><input type="checkbox" id="brand6" value=""/> <label
                                                    for="brand6"><span></span> Dolorem ipsum quia.</label></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
